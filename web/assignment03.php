...
<!-- 
    ...
    <div class="grid-container">
        <div class="grid-item">1973 Ford RV <br><img src="carpicks/20170920_122606.jpg"><input type="checkbox" name="RV" value="1973 Ford RV">Add to Cart</div>
        <div class="grid-item">2015 Ford Fusion <br><img src="carpicks/DSCN0471.JPG"><input type="checkbox" name="Fusion" value="2015 Ford Fusion">Add to Cart</div>
        <div class="grid-item">1985 Honda 3 Wheeler <br><img src="carpicks/left.jpg"><input type="checkbox" name="Honda" value="1985 Honda 3 Wheeler">Add to Cart</div>
    </div>
</form>
